...
class TextRecognitionCubit extends Cubit<TextRecognitionStates> {
  ...
  void changeTextType(String newValue) {
    textType = newValue;
    emit(ChoiceTextTypeSuccessState());
  }
  ...
  Future textRecognition(
      File img, TextRecognitionScript textRecognitionScript) async {
    emit(GetTextRecognitionLoadingState());
    final textRecognition =
